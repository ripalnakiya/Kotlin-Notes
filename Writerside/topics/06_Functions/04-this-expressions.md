...
To access `this` from an outer scope (a [class](01-classes.md), [extension function](03-extensions.md),
or labeled [function literal with receiver](03-lambda-expressions-and-anonymous-functions.md#function-literals-with-receiver)) you write `this@label`,
where `@label` is a [label](03-returns.md) on the scope `this` is meant to be from:
