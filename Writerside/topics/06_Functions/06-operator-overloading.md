...
```
When [overriding](06-inheritance.md#overriding-methods) your operator overloads, you can omit `operator`:
...
> These operations, as well as all the others, are optimized for [basic types](01-types-overview.md) and do not introduce
...
in [Delegated properties](14-delegated-properties.md).

## Infix calls for named functions

You can simulate custom infix operations by using [infix function calls](01-functions.md#infix-notation).
