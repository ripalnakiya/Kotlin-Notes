...
You can use properties in [classes](01-classes.md), [interfaces](04-interfaces.md), [objects](07-object-declarations.md), [companion objects](07-object-declarations.md#companion-objects),
...
In Kotlin, you can change accessor visibility or add [annotations](https://kotlinlang.org/docs/annotations.html) without replacing the default implementation.
...
* Are read-only (`val`).
* Aren't `open`.
* Aren't a [delegated property](14-delegated-properties.md).
* Aren't [compile-time constants](#compile-time-constants).

In addition, the backing field type must be a subtype of the property's type and have [`private` visibility](02-visibility-modifiers.md).
...
* They must be either a top-level property, or a member of an [`object` declaration](07-object-declarations.md#object-declarations-overview) or a [companion object](07-object-declarations.md#companion-objects).
* They must be initialized with a value of type `String` or a [primitive type](01-types-overview.md).
* They can't have a custom getter.

Compile-time constants still have a backing field, so you can interact with them using [reflection](https://kotlinlang.org/docs/reflection.html).
...
In all cases, the property or variable must be non-nullable and must not be a [primitive type](01-types-overview.md).
...
See [Overriding properties](06-inheritance.md#overriding-properties).
...
For more information, see [delegated properties](14-delegated-properties.md).
