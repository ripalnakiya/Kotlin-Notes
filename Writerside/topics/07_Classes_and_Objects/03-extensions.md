...
For more information, see [Lambda expressions and anonymous functions](03-lambda-expressions-and-anonymous-functions.md).
...
If a class defines a [companion object](07-object-declarations.md#companion-objects), you can also define extension
...
precedence. To access the dispatch receiver explicitly, use the [qualified `this` syntax](04-this-expressions.md#qualified-this):
...
Extensions use the same [visibility modifiers](02-visibility-modifiers.md) as regular functions declared in the same scope, including extensions
...
For more information, see [Imports](https://kotlinlang.org/docs/packages.html#imports).
