...
[lambda expressions](03-lambda-expressions-and-anonymous-functions.md).
...
Starting from 1.6.20, Kotlin supports [callable references](https://kotlinlang.org/docs/reflection.html) to functional interface constructors, which
...
You can also simply rewrite the above using a [type alias](08-type-aliases.md) for a functional type:
