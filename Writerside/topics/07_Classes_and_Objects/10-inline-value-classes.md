...
usages (similar to how content of [inline functions](05-inline-functions.md) is inlined to call sites).

## Members

Inline classes support some functionality of regular classes. In particular, they are allowed to declare properties and
functions, have an `init` block and [secondary constructors](01-classes.md#secondary-constructors):
...
Inline class properties cannot have [backing fields](13-properties.md#backing-fields). They can only have simple computable
...
[represented](02-numbers.md#boxing-and-caching-numbers-on-the-jvm) either as a primitive `int` or as the wrapper `Integer`.
...
Because inline classes may be represented both as the underlying value and as a wrapper, [referential equality](09-equality.md#referential-equality)
...
[Calling Kotlin from Java](https://kotlinlang.org/docs/java-to-kotlin-interop.html#inline-value-classes).

## Inline classes vs type aliases

At first sight, inline classes seem very similar to [type aliases](08-type-aliases.md). Indeed, both seem to introduce
