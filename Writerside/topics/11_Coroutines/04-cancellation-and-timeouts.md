...
along with its children, as defined by [structured concurrency](01-coroutine-basics.md#coroutine-scope-and-structured-concurrency).
...
[Coroutine builder functions](01-coroutine-basics.md#coroutine-builder-functions) such as
[`.launch()`](01-coroutine-basics.md#coroutinescope-launch) return a `Job`. The [`.async()`](01-coroutine-basics.md#coroutinescope-async)
...
[Structured concurrency](01-coroutine-basics.md#coroutine-scope-and-structured-concurrency) ensures that canceling a coroutine also cancels all of its children.
...
When a coroutine is canceled, it continues running until it reaches a point in the code where it may suspend, 
...
When a suspended coroutine is canceled, it resumes with a `CancellationException` instead of returning any values, 
