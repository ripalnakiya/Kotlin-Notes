...
it isn't mandatory. For example, if your subject is a `Boolean`, [`enum` class](09-enum-classes.md), [`sealed` class](08-sealed-classes.md),
...
Use parentheses around the boolean expressions to [avoid confusion](https://kotlinlang.org/docs/coding-conventions.html#guard-conditions-in-when-expression):
