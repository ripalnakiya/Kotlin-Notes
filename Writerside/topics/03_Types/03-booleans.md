...
> To evaluate both operands, use the `and` [infix function](01-functions.md#infix-notation) instead.
>
{style="note"}
...
> To evaluate both operands, use the `or` [infix function](01-functions.md#infix-notation) instead.
>
{style="note"}
...
> `xor` is an [infix function](01-functions.md#infix-notation), not an operator.
>
...
[`if`](01-conditions.md#if-expression), [`when`](01-conditions.md#when-expressions-and-statements),
and [`while`](02-loops.md#while-loops) evaluate `Boolean` expressions to direct program flow.
