...
> To identify the type of an object at runtime, see [Reflection](https://kotlinlang.org/docs/reflection.html).
>
{type="tip"}
...
Smart casts work not only for `if` conditional expressions, but also for [`when` expressions](01-conditions.md#when-expressions-and-statements):
...
The compiler can smart-cast variables captured within lambda functions that are passed to [inline functions](05-inline-functions.md).
...
<table>
    <tr>
        ...
        <td>
            Always, except <a href="14-delegated-properties.md">local delegated properties</a>.
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            If the property is <code>private</code>, <code>internal</code>, or if the check is performed in the same <a href="02-visibility-modifiers.md#modules">module</a> where the property is declared. Smart casts can't be used on <code>open</code> properties or properties that have custom getters.
        </td>
    </tr>
    <tr>
        <td>
