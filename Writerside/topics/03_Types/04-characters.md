...
The [`Char`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-char/) type represents a single character as a UTF-16
code unit.

Use `Char` for individual character values, such as letters, digits,
punctuation marks, or whitespace. For sequences of characters, use [`String`](05-strings.md).
...
> [numeric types](02-numbers.md#boxing-and-caching-numbers-on-the-jvm).
>
{style="note"}
...
To compare `Char` values, use standard [comparison operators](https://kotlinlang.org/docs/keyword-reference.html#operators-and-special-symbols) such
as `==`, `!=`, `<`, `>`, `<=`, and `>=`.
